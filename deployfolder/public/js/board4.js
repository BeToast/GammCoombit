...
const server1white = database.ref("/lobbybase/server4/white");
const server1black = database.ref("/lobbybase/server4/black");
const boardstring = database.ref("/lobbybase/server4/board");
const movestring = database.ref("/lobbybase/server4/move");
