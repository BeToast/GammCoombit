...
const server1white = database.ref("/lobbybase/server3/white");
const server1black = database.ref("/lobbybase/server3/black");
const boardstring = database.ref("/lobbybase/server3/board");
const movestring = database.ref("/lobbybase/server3/move");
